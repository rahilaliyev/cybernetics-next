    ...
    <main>
      ...
      <section className="sislat-text">
        <div className="sislat-text-container container">
          ...
          <p>Müşteri memnuniyetini ön planda tutan, insan odaklı yaklaşımı benimsemiş ekibimiz ile size yardımcı olmaya hazırız.</p>
        </div>
      </section>
      <section className="sislat-index-wall">
        <div className="sislat-index-wall-container container">
          <div className="left">
            ...
            <p>
              Giderek karmaşıklaşan güvenlik tehditlerinden korkmayın! Coslat, gelişmiş güvenlik duvarı özellikleri ile siber tehditlere karşı
              yanınızda.
            </p>
            <ul>
      ...
      <section className="sislat-index-hotspot">
        <div className="sislat-index-hotspot-container container">
          ...
          <div className="right">
            <h3>Hizmet Portalı/Hotspot</h3>
            <p>
              Misafirlerinizin güvenli bir şekilde internete çıkmasını sağlarken, erişimlerini 5651 Sayılı Kanuna uygun olarak kayıt altına alıyor.
            </p>
            <ul>
              <li>TC Kimlik Doğrulama ve SMS ile Kayıt</li>
              <li>Türkçe Web arayüz</li>
      ...
      <section className="sislat-index-coslat">
        <div className="sislat-index-coslat-container container">
          <div className="left">
            <h3>Coslat 2FA</h3>
            <p>
              Parolanız çalınsa bile siber saldırganların ağınıza erişimini engeller! Kimlik Doğrulama sürecinde SMS ya da Google Authenticator ile 2
              aşamalı doğrulama sağlayarak VPN bağlantılarınızı daha güvenli hale getirir.
            </p>
            <ul>
