    ...
    <main>
        ...
        <div className="preparation-details-wrapper">
          <div className="preparation-details-container container">
            <div className="details-header">
              ...
              <h1>Web Proqramlaşdırma</h1>
              <p>
                Həyatımızın bir parçasına çevrilmiş texnologiyaya qarşı asılılığımız günü gündən artır və elə bu səbəbdən, biz Kiber Təhlükəsizliyin
                əhəmiyyətini göz ardı edə bilmərik. Kiber təhlükəsizlik sistemlərin, şəbəkələrin və proqramların rəqəmsal hücumlardan qorunmasıdır. Bu
                kiberhücumlar məlumatları əldə etmək, dəyişdirmək və ya məhv etmək məqsədi daşıyır. Kiber təhlükəsizlik analitiki interneti hər kəs
                üçün daha təhlükəsiz edir. v
              </p>
      ...
      <section className="applying">
        <div className="applying-container container">
          ...
          <p>
            Analitik və diaqnostik bacarıqları olan və kodlaşdırmaya marağı olan hər kəs proqrama qoşula bilər. Bunun üçün sizdən xüsusi təhsil
            göstəricisi deyil, komandada işləmə bacarığı və detallara diqqət tələb olunur.
          </p>
      ...
      <section className="career">
        <div className="career-container container">
          ...
          <div className="career-container-context">
            <div className="left">
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pretium aliquam purus proin ultrices id scelerisque imperdiet morbi. Pharetra
                duis ut arcu venenatis. Dui interdum laoreet orci dictum ut mi laoreet erat urna. Pretium posuere ultricies cras volutpat curabitur.
                Ut id ut sodales risus aenean tristique urna nibh. Blandit viverra massa dolor, in convallis duis id. Orci nisl in faucibus sed
                nascetur feugiat placerat. Donec elit dignissim integer eu, morbi sagittis, sed ultrices. Pretium sed neque in pretium nulla nisl.
                Sapien velit, massa pharetra sagittis, a est at dolor. Imperdiet morbi tortor tempor, viverra id purus. Nibh condimentum adipiscing
                pretium donec sagittis. Neque tristique nibh vel eu. Dignissim turpis sed adipiscing habitasse at velit et. Malesuada ornare donec
                consequat luctus rhoncus. Adipiscing convallis ridiculus sed gravida.
              </p>
            </div>
            <div className="right">
              <div className="image">
        ...
        <div className="about-education-container container">
          ...
          <div className="about-education-container-cards">
            <div className="card">
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mattis arcu tristique amet enim purus. Nulla et eu velit nisl, arcu lobortis
                urna pulvinar. Venenatis arcu morbi donec donec ultrices.
              </p>
            </div>
            <div className="card">
              <h3>Et justo aliquet id.</h3>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras suspendisse dolor elit lectus at. Nulla at erat velit tincidunt aliquet
                diam id. In nisl lorem et luctus. Ipsum suscipit tortor purus enim.
              </p>
            </div>
            <div className="card">
